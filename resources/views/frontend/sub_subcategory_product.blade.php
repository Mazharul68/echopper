                                    ...
                                    <div class="accordion-group">
                                        ...
                                        <div class="accordion-body collapse" id="collapse{{ $cat->id }}" style="height: 0px;">
                                            <div class="accordion-inner">
                                                @php
                                                    $subsubcategories = App\models\Subcategory::where('category_id',$cat->id)->orderBy('subcategory_name_en','ASC')->get();
                                                @endphp
                                                <ul>
			                    ...
			                    <div class="products">
	                                <div class="product">
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="detail.html"><img  src="{{ asset($product->product_thambnail) }}"></a>
                                            </div><!-- /.image -->
                                        ...
                                        <div class="product-info text-left">
                                            <h3 class="name">
                                                ...
                                                @if(session()->get('language')=='bangla')
                                                <a href="">{{ $product->product_name_bn }}</a>
                                                @else
                                                <a href="">{{ $product->product_name_en }}</a>
                                                @endif
                                                    ...
                                                    <div class="action">
                                                        <ul class="list-unstyled">
                                                            <li class="add-cart-button btn-group">
                                                                ...
                                                                <button onclick="addToCart()" class="btn btn-primary cart-btn" type="button">Add to cart</button>
