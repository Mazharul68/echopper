...
@section('title') @if(session()->get('language')== 'bangla') {{ $product->product_name_bn }} @else {{ $product->product_name_en }} @endif @endsection
            ...
            <div id="owl-single-product-thumbnails">
                ...
                @endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info" id="pname">
                            <h1 class="name">@if(session()->get('language')== 'bangla')
							...
							<div class="price-container info-container m-t-20">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										@else
										<div class="form-group">
											<label for="size"><b>@if(session()->get('language')=='bangla')
												সাইজ পছন্দ করুন
												@else
												Select Size
												@endif</b></label>
									...
									<div class="col-sm-3">
										<div class="cart-quantity">
											<div class="quant-input">
												...
												<input class="form-control form-control-lg" type="text" id="qty" value="1" min="1">
