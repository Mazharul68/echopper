...
@section('content')
@section('title') @if(session()->get('language')== 'bangla') হোম @else HOME @endif
  @endsection
								...
								<div class="col col-xs-5">
									<div class="product-image">
										<div class="image">
											...
											@if (session()->get('language') == 'bangla')
											<a href="{{ url('sigle/product/'.$product->id.'/'.$product->product_slug_bn) }}"><img  src="{{asset($product->product_thambnail)}}"></a>

											@else

											<a href="{{ url('sigle/product/'.$product->id.'/'.$product->product_slug_en) }}"><img  src="{{asset($product->product_thambnail)}}"></a>
											@endif
								...
								<div class="col col-xs-7">
									<div class="product-info">
										<h3 class="name">
											...
											@if (session()->get('language') == 'bangla')
											<a href="{{ url('sigle/product/'.$product->id.'/'.$product->product_slug_bn) }}">
										...
										@else
										<a href="{{ url('sigle/product/'.$product->id.'/'.$product->product_slug_en) }}">
						...
						<div class="products">
							<div class="product">
								<div class="product-image">
									...
									@endphp
									<div class="tag new" style="background: green;">
										@if($product->discount_price == NULL)
										<span>
											@if	(session()->get('language') == 'bangla')
											নতুন
								...
								<div class="product-info text-left">
									...
									<h3 class="name">
										<a href="{{ url('sigle/product/'.$product->id.'/'.$product->product_slug_bn) }}">{{ $product->product_name_bn }}</a></h3>
									@else
									<h3 class="name"><a href="{{ url('sigle/product/'.$product->id.'/'.$product->product_slug_en) }}">{{ $product->product_name_en }}</a></h3>
									@endif
									...
									<div class="action">
										<ul class="list-unstyled">
											<li class="add-cart-button btn-group">
												...
												<button data-toggle="modal" data-target="#carmodal" id="{{ $product->id }}" onclick="ProductView(this.id)" class="btn btn-primary icon" type="button" title="Add Cart">
												...
												<button type="button" class=" btn btn-primary icon" title="Add to Wishlist" id="{{ $product->id }}" onclick="AddToWishlist(this.id)">
		...
		<div class="tab-pane" id="category{{ $category->id }}">
			<div class="product-slider">
				<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
					...
					@endphp
					@forelse ($catwiseproduct as $category)
					<div class="item item-carousel">
						<div class="products">
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html"><img  src="{{asset($category->product_thambnail)}}" ></a>
									</div><!-- /.image -->
									<div class="tag new"><span>new fd</span></div>
								</div><!-- /.product-image -->
								<div class="product-info text-left">
					...
					@empty
					@if	(session()->get('language') == 'bangla')
					<h4 class="text-danger">কোন পণ্য পাওয়া যায় নি</h4>
					@else
						...
						<div class="action">
							<ul class="list-unstyled">
								<li class="add-cart-button btn-group">
									...
									<button data-toggle="modal" data-target="#carmodal" class="btn btn-primary icon" id="{{ $product->id }}" onclick="ProductView(this.id)" type="button" title="Add Cart">
										<i class="fa fa-shopping-cart"></i>
									</button>
...
<!-- ============ Skip Category Start Here ====================== -->
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">
		@if	(session()->get('language') == 'bangla')
		{{ $skin_category_0->category_name_bn }}
		@else
		{{ $skin_category_0->category_name_en }}
		@endif
	</h3>
	<div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
...
<!-- ============ Skip Category-1 Start Here ====================== -->
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">
		@if	(session()->get('language') == 'bangla')
		{{ $skin_category_1->category_name_bn }}
		@else
		{{ $skin_category_1->category_name_en }}
		@endif
	</h3>
	<div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
			...
			<div class="products">
				<div class="product">
					...
					<div class="product-info text-left">
						<h3 class="name">
							@if (session()->get('language')== 'bangla')
							<a href="{{ 'sigle/product/'.$product->id.'/'.$product->product_slug_bn }}">
								{{ $product->product_name_bn }}</a>
								@else
								<a href="{{ 'sigle/product/'.$product->id.'/'.$product->product_slug_en }}">
								{{ $product->product_name_en }}</a>
								@endif
						</h3>
						<div class="rating rateit-small"></div>
...
<!-- ============ Skip Category-2 Start Here ====================== -->
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">
		@if	(session()->get('language') == 'bangla')
		{{ $skin_category_2->category_name_bn }}
		@else
		{{ $skin_category_2->category_name_en }}
		@endif
	</h3>
	<div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
