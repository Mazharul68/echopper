  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>E-SHOPPER</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            ...
            <h2><span style="color: green;">Grand Total:</span> {{ $order->amount }}tk</h2>
