...
@section('dashboard')
    active
@endsection
@section('title') @if(session()->get('language')== 'bangla') এডমিন ড্যাসবোর্ড @else ADMIN DASHBOARD @endif @endsection
@section('admin_content')

 <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="{{ '/' }}" target="_blank">E-SHOPPER</a>
