...
@section('comfirmed-order')
active
@endsection


@section('title') @if(session()->get('language')== 'bangla') নিশ্চিতভাবে @else Confirm-Order @endif @endsection
...
@section('admin_content')
 ...
 <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Cofirmed Orders</span>
      </nav>
